...
namespace mvc_crud.Controllers
{
    public class CadastroController : Controller
    {
        ...
        public CadastroController(mvc_crudContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("Id,Nome,Nascimento,Celular,Email")] Cadastro cadastro)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Nome,Nascimento,Celular,Email")] Cadastro cadastro)
        {
            if (id != cadastro.Id)
            {
                return NotFound();
